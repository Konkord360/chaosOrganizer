...
class PaymentControllerTest {
    ...
    void testGetPaymentsReturnsCorrectPayments() throws Exception {
        ...
        this.mockMvc.perform(get("/getPayments?userEmail=testemail@gmail.com")).andDo(print())
    ...
    void testAddsProperly() throws Exception {
        ...
        when(userRepository.findByEmail(any())).thenReturn(user);
        this.mockMvc.perform(post("/addPayment?userEmail=testemail@gmail.com").contentType(MediaType.APPLICATION_JSON).characterEncoding("UTF-8")
    ...
    void testDeletesProperly() throws Exception {
        ...
        this.mockMvc.perform(delete("/deletePayment?userEmail=testemail@gmail.com&paymentIndex=1").contentType(MediaType.APPLICATION_JSON).characterEncoding("UTF-8")).andDo(print())
                .andExpect(status().isOk())
